...
- [ ] **WEICH — Block-Aufteilung.** TextWorld und ToH als getrennte Blöcke (Resume-Grenzen, Fehlerisolation); `errors.jsonl` nach jedem Block sichten, Reruns nur für dokumentierte Infrastrukturfehler (§5.8-Regel). **Offene Unterfragen (2026-07-20, noch nicht geklärt):** siehe `docs/consistency_log.md`, Eintrag zur Block-Aufteilungs-Klärung.
