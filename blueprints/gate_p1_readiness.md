...
- [ ] **HART.** ToH-Parseability > 80 % mit Qwen3-8B bei C0 (20 Episoden, 3 Disks). Unterschreitung → `include_valid_moves`-Fallback aktivieren und als preregistrierte Konfigurationsänderung dokumentieren. *Evidenz: Pilot-Summary.*
